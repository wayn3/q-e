...
!
  ...
  !
  integer, parameter:: nxc=10, ncc=10, ngcx=41, ngcc=12, nmeta=5, ncnl=6 !@WC
  ...
  data gradx / 'NOGX', 'B88', 'GGX', 'PBX',  'RPB', 'HCTH', 'OPTX',&
               ...
               'xxxx', 'xxxx', 'xxxx', 'xxxx', 'BR0', 'xxxx', 'C090', 'CAM' / !@WC
...
CONTAINS
  ...
  subroutine set_dft_from_name( dft_ )
    ...
    ! special case : CAM
       dft_defined = set_dft_values(10,4,41,4,0,0)
 ...
 !-----------------------------------------------------------------------
  ...
  if (iexch==1.and.igcx==0.and.igcc==0) then
     ...
     shortname = 'HSE'
  else if (iexch==10.and.icorr==4.and.igcx==41.and.igcc==4) then !@WC
     shortname = 'CAM' !
...
subroutine gcx_spin (rhoup, rhodw, grhoup2, grhodw2, &
  ...
  elseif (igcx == 3 .or. igcx == 4 .or. igcx == 8 .or. igcx ==10 .or. &
          igcx ==12 .or. igcx ==20 .or. igcx ==23 .or. igcx ==24 .or. igcx == 25 .or. igcx == 41) then !@WC
